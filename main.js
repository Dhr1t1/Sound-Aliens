function startClassifcation(){
    ...
    classifier=ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/lFCxQZ3lX/model.json', modelReady);
}
...
function gotResults(error,results){
    if (error){
        ...
        document.getElementById("result_confidence").innerHTML="Accurucy- "+(results[0].confidence*100).toFixed(2)+" %";
        ...
        else if (results[0].label=="Bacground Noise"){
            img_1.src='aliens-01.png';
            img_2.src='aliens-02.png';
            img_3.src='aliens-03.png';
